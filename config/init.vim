...
" Install coc for code completion
...
Plug 'tpope/vim-commentary' " comment out lines with gcc, targets with gc
...
if executable('rg')
  let g:ctrlp_user_command = '~/bin/linux_rg/rg %s --files --hidden --color=never --glob ""' endif
endif
