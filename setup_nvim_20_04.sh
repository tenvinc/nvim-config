...
then
    ...
    cmake -H. -BRelease -DCMAKE_BUILD_TYPE=Release -DCMAKE_PREFIX_PATH=$PWD/clang+llvm-13.0.0-x86_64-linux-gnu-ubuntu-20.04 -DCMAKE_INSTALL_PREFIX=$HOME/ccls
    cmake --build Release
